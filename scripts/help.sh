...
echo "make desktop-gpu-dgpu Force the dGPU as the desktop compositor/apps default"
echo "make desktop-gpu-igpu Force the iGPU as the desktop compositor/apps default"
echo "make desktop-gpu-reset Remove the desktop default-GPU override"
