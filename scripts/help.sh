...
echo "make fix-codex-context Correct OmniRoute's codex GPT-5.6 context-window overrides"
echo "make backup-combos Snapshot OmniRoute combos (name/models/strategy) to a timestamped file"
echo "make restore-combos Restore OmniRoute combos from a backup-combos snapshot"
